// Script para resetar o banco de dados do Supabase para testes
...
async function resetDatabase() {
  ...
  try {
    ...
    const { error: queueError } = await supabase
      .from('queue')
      .delete()
      .gt('id', 0); // Condição para deletar todos os registros
    ...
    const { error: roomsError } = await supabase
      ...
      .gt('id', 0); // Condição para atualizar todos os registros
